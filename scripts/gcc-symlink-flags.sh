...
((_gcc_symlink_flags & _BINUTILS_BIT)) && _gcc_list="${_gcc_list:+${_gcc_list} }binutils"
((_gcc_symlink_flags & _NEWLIB_BIT)) && _gcc_list="${_gcc_list:+${_gcc_list} }newlib"
...
unset _GMP_BIT _ISL_BIT _MPC_BIT _MPFR_BIT _ZLIBC_BIT _BINUTILS_BIT _NEWLIB_BIT _gcc_list _remaining_args
